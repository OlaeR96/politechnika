...
def test_grad2rad():
    assert grad2rad(0) == 0
    assert grad2rad(50) == 0.7853981633974484
    assert grad2rad(100) == 1.5707963267948968
    assert grad2rad(150) == 2.356194490192345
    assert grad2rad(200) == 3.1415926535897936
    assert grad2rad(250) == 3.926990816987242
    assert grad2rad(300) == 4.71238898038469
    assert grad2rad(350) == 5.497787143782139
    assert grad2rad(400) == 6.283185307179587
